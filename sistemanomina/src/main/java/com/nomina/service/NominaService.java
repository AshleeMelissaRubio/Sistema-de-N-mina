    ...
    public void procesarNominaCompleta() {
        try {
            ...
            if (empleados.isEmpty()) {
                System.out.println("Advertencia: No se encontraron empleados registrados en el sistema.");
                return;
            }
            ...
            System.out.printf("Retenciones y Deducciones Totales: $%,15.2f%n", totalDeduccionesEmpresa);
